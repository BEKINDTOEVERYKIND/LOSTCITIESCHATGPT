 ...
 */
#ifndef POLICY_COST_V10_H
#define POLICY_COST_V10_H
...
#define POLICY_COST_V10_VERSION 4U
...
#define POLICY_COST_V10_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202709140101)
