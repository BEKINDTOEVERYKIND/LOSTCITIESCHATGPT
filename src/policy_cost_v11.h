 ...
 */
#ifndef POLICY_COST_V11_H
#define POLICY_COST_V11_H
...
#define POLICY_COST_V11_VERSION 4U
...
#define POLICY_COST_V11_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202710140101)
