 ...
 */
#ifndef POLICY_COST_V16_H
#define POLICY_COST_V16_H
...
#define POLICY_COST_V16_VERSION 4U
...
#define POLICY_COST_V16_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202803140101)
