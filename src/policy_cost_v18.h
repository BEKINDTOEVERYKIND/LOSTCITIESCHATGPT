 ...
 */
#ifndef POLICY_COST_V18_H
#define POLICY_COST_V18_H
...
#define POLICY_COST_V18_VERSION 4U
...
#define POLICY_COST_V18_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202805140101)
...
typedef struct PolicyCostTable {
     ...
     * the integer pre-move State.nply through ply 64.  In current v18 tables,
