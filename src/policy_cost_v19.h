 ...
 */
#ifndef POLICY_COST_V19_H
#define POLICY_COST_V19_H
...
#define POLICY_COST_V19_VERSION 4U
...
#define POLICY_COST_V19_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202806140101)
...
typedef struct PolicyCostTable {
     ...
     * the integer pre-move State.nply through ply 64.  In current v19 tables,
