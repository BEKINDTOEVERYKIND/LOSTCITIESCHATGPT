 ...
 */
#ifndef POLICY_COST_V21_H
#define POLICY_COST_V21_H
...
#define POLICY_COST_V21_VERSION 4U
...
#define POLICY_COST_V21_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202808140101)
...
typedef struct PolicyCostTable {
     ...
     * the integer pre-move State.nply through ply 64.  In current v21 tables,
