 ...
 */
#ifndef POLICY_COST_V7_H
#define POLICY_COST_V7_H
...
#define POLICY_COST_V7_VERSION 4U
...
#define POLICY_COST_V7_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202705140101)
