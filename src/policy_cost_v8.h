 ...
 */
#ifndef POLICY_COST_V8_H
#define POLICY_COST_V8_H
...
#define POLICY_COST_V8_VERSION 4U
...
#define POLICY_COST_V8_SOURCE_SEED UINT64_C(202702140101)
#define POLICY_COST_SOURCE_SEED UINT64_C(202707140101)
