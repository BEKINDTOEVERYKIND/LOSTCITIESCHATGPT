    ...
    def test_plan_is_one_bounded_candidate_not_legal_move_enumeration(self) -> None:
        ...
        self.assertEqual(
            current_src - frozen_src,
            {
                ...
                "src/policy_cost_v8.c",
                "src/policy_cost_v8.h",
                "src/policy_cost_v9.c",
                "src/policy_cost_v9.h",
                "src/policy_cost_v10.c",
                "src/policy_cost_v10.h",
                "src/policy_cost_v11.c",
                "src/policy_cost_v11.h",
                "src/policy_cost_v12.c",
                "src/policy_cost_v12.h",
                "src/policy_cost_v13.c",
                "src/policy_cost_v13.h",
                "src/policy_cost_v14.c",
                "src/policy_cost_v14.h",
                "src/policy_cost_v15.c",
                "src/policy_cost_v15.h",
                "src/policy_cost_v16.c",
                "src/policy_cost_v16.h",
                "src/policy_cost_v17.c",
                "src/policy_cost_v17.h",
                "src/policy_cost_v18.c",
                "src/policy_cost_v18.h",
                "src/policy_cost_v19.c",
                "src/policy_cost_v19.h",
                "src/policy_cost_v20.c",
                "src/policy_cost_v20.h",
                "src/policy_cost_v21.c",
                "src/policy_cost_v21.h",
