...
SEEDS={"TRAIN":202712100101,"SELECT":202712100201,"TEST":202712100301}
...
def validate_contract_smoke(dp:Path,dhx:str,rp:Path,rhx:str,*,split:str,
 ...
 """Validate a real, small native v13 producer census with no efficacy path.
 ...
 seed_text=str(seed)
 if len(seed_text)!=12 or not seed_text.startswith("20271229"):
  raise AllocationError("contract smoke seed is outside burned 20271229")
 if not 1<=matches<=16:
 ...
 expected_header.update({
  ...
  "seed":seed_text,"seed_domain":"20271229-smoke",
 ...
 payload=(
  b"lc-policy-cost-v13-native-consumer-contract-v1\0"+
