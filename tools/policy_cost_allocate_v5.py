...
SEEDS={"TRAIN":202703100101,"SELECT":202703100201,"TEST":202703100301}
...
def validate_contract_smoke(dp:Path,dhx:str,rp:Path,rhx:str,*,split:str,
 ...
 """Validate a real, small native v5 producer census with no efficacy path.
 ...
 seed_text=str(seed)
 if len(seed_text)!=12 or not seed_text.startswith("20270329"):
  raise AllocationError("contract smoke seed is outside burned 20270329")
 if not 1<=matches<=16:
 ...
 expected_header.update({
  ...
  "seed":seed_text,"seed_domain":"20270329-smoke",
 ...
 payload=(
  b"lc-policy-cost-v5-native-consumer-contract-v1\0"+
