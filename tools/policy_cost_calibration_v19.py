...
# early and late strata remained positive.  v19 therefore tests one new,
...
DEFAULT_FOLD_SEED = "202806140101"
MAX_ROUND_PLY = 299
...
def policy_active_anchor_indices(anchors: Sequence[int]) -> tuple[int, ...]:
    """Indices of policy-cost knots that v19 is allowed to estimate."""
...
def calibrate_policy_cost(
    ...
    if campaign_evidence_binding is None:
        ...
        if not checked_config.require_campaign_design or set(campaign_evidence_binding) != required_evidence or \
                campaign_evidence_binding.get("schema") != "lc-policy-cost-v19-train-evidence-binding-v1" or \
