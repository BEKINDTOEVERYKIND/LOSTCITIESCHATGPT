...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202611100101), UINT64_C(202611110101),
      UINT64_C(202611120101), UINT64_C(202611130101),
      UINT64_C(202611160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202611100201), UINT64_C(202611110201),
      UINT64_C(202611120201), UINT64_C(202611130201),
      UINT64_C(202611160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202611100301), UINT64_C(202611110301),
      UINT64_C(202611120301), UINT64_C(202611130301),
      UINT64_C(202611160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v2\","
        ...
        (unsigned long long)root_seed,c->smoke?"20261129-smoke":"locked-discovery",
    ...
    int printed=0;for(int m=0;m<PC_MASKS;m++){
        ...
        if(!p->have_decision[m])fputs("null",f);
            ...
            fprintf(f,"{\"leader_position\":%d,\"selected_position\":%d,"
                "\"anchor_interval\":%d,\"lambda_action\":%.17g,"
                "\"lambda_draw\":%.17g,\"all_pair_passed\":%s,"
                "\"prior_protected_rivals\":%d,\"actions\":[",
                d->leader,d->selected,d->anchor_interval,d->lambda_action,
                d->lambda_draw,d->all_pair_passed?"true":"false",
                                       ...
                                       int split,const PolicyCostTable *table)
{
    ...
    static const int onset[6]={14,12,10,8,4,0};fputc('{',f);first=1;
    for(int o=0;o<6;o++)for(int m=1;m>=0;m--){
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20261129...]\n"
      ...
      "seed must be in the burned 20261129 namespace and is labeled unusable "
      ...
      "smoke, 202611010101, and every 20261129 feasibility-smoke seed are "
