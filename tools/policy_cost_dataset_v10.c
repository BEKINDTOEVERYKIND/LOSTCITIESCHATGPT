...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202709100101), UINT64_C(202709110101),
      UINT64_C(202709120101), UINT64_C(202709130101),
      UINT64_C(202709160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202709100201), UINT64_C(202709110201),
      UINT64_C(202709120201), UINT64_C(202709130201),
      UINT64_C(202709160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202709100301), UINT64_C(202709110301),
      UINT64_C(202709120301), UINT64_C(202709130301),
      UINT64_C(202709160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20270929",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20270929-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202705010101, 202709010101, and every "
        "20270929 feasibility-smoke seed\"}\n");
...
static int run_evaluate(const EvaluateConfig *c)
{
    ...
    fprintf(output.file,",\"root_net_fingerprint\":\"%016llx\","
        ...
        "feasibility-smoke seed, 202708010101, 202709010101, and every "
        "20270929 feasibility-smoke seed\","
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20270929...]\n"
      ...
      "seed must be in the burned 20270929 namespace and is labeled unusable "
      ...
      "202705010101, 202709010101, and every 20270929 "
