...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202711100101), UINT64_C(202711110101),
      UINT64_C(202711120101), UINT64_C(202711130101),
      UINT64_C(202711160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202711100201), UINT64_C(202711110201),
      UINT64_C(202711120201), UINT64_C(202711130201),
      UINT64_C(202711160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202711100301), UINT64_C(202711110301),
      UINT64_C(202711120301), UINT64_C(202711130301),
      UINT64_C(202711160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20271129",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20271129-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202705010101, 202711010101, and every "
        "20271129 feasibility-smoke seed\"}\n");
...
static int run_evaluate(const EvaluateConfig *c)
{
    ...
    fprintf(output.file,",\"root_net_fingerprint\":\"%016llx\","
        ...
        "feasibility-smoke seed, 202710010101, 202711010101, and every "
        "20271129 feasibility-smoke seed\","
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20271129...]\n"
      ...
      "seed must be in the burned 20271129 namespace and is labeled unusable "
      ...
      "202705010101, 202711010101, and every 20271129 "
