...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202712100101), UINT64_C(202712110101),
      UINT64_C(202712120101), UINT64_C(202712130101),
      UINT64_C(202712160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202712100201), UINT64_C(202712110201),
      UINT64_C(202712120201), UINT64_C(202712130201),
      UINT64_C(202712160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202712100301), UINT64_C(202712110301),
      UINT64_C(202712120301), UINT64_C(202712130301),
      UINT64_C(202712160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20271229",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20271229-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202711010101, 202712010101, and every "
        "20271229 feasibility-smoke seed\"}\n");
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20271229...]\n"
      ...
      "seed must be in the burned 20271229 namespace and is labeled unusable "
      ...
      "202705010101, 202712010101, and every 20271229 "
