...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202801100101), UINT64_C(202801110101),
      UINT64_C(202801120101), UINT64_C(202801130101),
      UINT64_C(202801160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202801100201), UINT64_C(202801110201),
      UINT64_C(202801120201), UINT64_C(202801130201),
      UINT64_C(202801160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202801100301), UINT64_C(202801110301),
      UINT64_C(202801120301), UINT64_C(202801130301),
      UINT64_C(202801160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20280129",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20280129-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202711010101, 202801010101, and every "
        "20280129 feasibility-smoke seed\"}\n");
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20280129...]\n"
      ...
      "seed must be in the burned 20280129 namespace and is labeled unusable "
      ...
      "202705010101, 202801010101, and every 20280129 "
