...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202803100101), UINT64_C(202803110101),
      UINT64_C(202803120101), UINT64_C(202803130101),
      UINT64_C(202803160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202803100201), UINT64_C(202803110201),
      UINT64_C(202803120201), UINT64_C(202803130201),
      UINT64_C(202803160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202803100301), UINT64_C(202803110301),
      UINT64_C(202803120301), UINT64_C(202803130301),
      UINT64_C(202803160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20280329",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20280329-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202711010101, all policy-cost-v14 fixed seeds in 20280110/11/12/13/14/15/16/21/22, every 20280129 feasibility-smoke seed, 202801010101, 202802010101, all policy-cost-v15 fixed seeds in 20280210/11/12/13/14/15/16/21/22, every 20280229 feasibility-smoke seed, 202803010101, and every "
        "20280329 feasibility-smoke seed\"}\n");
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20280329...]\n"
      ...
      "seed must be in the burned 20280329 namespace and is labeled unusable "
      ...
      "202705010101, 202803010101, and every 20280329 "
