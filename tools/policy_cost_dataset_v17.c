...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202804100101), UINT64_C(202804110101),
      UINT64_C(202804120101), UINT64_C(202804130101),
      UINT64_C(202804160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202804100201), UINT64_C(202804110201),
      UINT64_C(202804120201), UINT64_C(202804130201),
      UINT64_C(202804160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202804100301), UINT64_C(202804110301),
      UINT64_C(202804120301), UINT64_C(202804130301),
      UINT64_C(202804160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20280429",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20280429-smoke":"locked-discovery",
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20280429...]\n"
      ...
      "seed must be in the burned 20280429 namespace and is labeled unusable "
      ...
      "202705010101, 202804010101, and every 20280429 "
