...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202805100101), UINT64_C(202805110101),
      UINT64_C(202805120101), UINT64_C(202805130101),
      UINT64_C(202805160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202805100201), UINT64_C(202805110201),
      UINT64_C(202805120201), UINT64_C(202805130201),
      UINT64_C(202805160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202805100301), UINT64_C(202805110301),
      UINT64_C(202805120301), UINT64_C(202805130301),
      UINT64_C(202805160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20280529",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20280529-smoke":"locked-discovery",
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20280529...]\n"
      ...
      "seed must be in the burned 20280529 namespace and is labeled unusable "
      ...
      "202805010101, and every 20280529 "
