...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202806100101), UINT64_C(202806110101),
      UINT64_C(202806120101), UINT64_C(202806130101),
      UINT64_C(202806160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202806100201), UINT64_C(202806110201),
      UINT64_C(202806120201), UINT64_C(202806130201),
      UINT64_C(202806160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202806100301), UINT64_C(202806110301),
      UINT64_C(202806120301), UINT64_C(202806130301),
      UINT64_C(202806160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20280629",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20280629-smoke":"locked-discovery",
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20280629...]\n"
      ...
      "seed must be in the burned 20280629 namespace and is labeled unusable "
      ...
      "202806010101, and every 20280629 "
