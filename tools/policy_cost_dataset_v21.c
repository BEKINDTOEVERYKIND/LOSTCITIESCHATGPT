...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202808100101), UINT64_C(202808110101),
      UINT64_C(202808120101), UINT64_C(202808130101),
      UINT64_C(202808160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202808100201), UINT64_C(202808110201),
      UINT64_C(202808120201), UINT64_C(202808130201),
      UINT64_C(202808160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202808100301), UINT64_C(202808110301),
      UINT64_C(202808120301), UINT64_C(202808130301),
      UINT64_C(202808160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20280829",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20280829-smoke":"locked-discovery",
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20280829...]\n"
      ...
      "seed must be in the burned 20280829 namespace and is labeled unusable "
      ...
      "202806010101, all policy-cost-v19 fixed seeds in 20280610/11/12/13/14/15/16/21/22, every 20280629 feasibility-smoke seed, 202807010101, all policy-cost-v20 fixed seeds in 20280710/11/12/13/14/15/16/21/22, every 20280729 feasibility-smoke seed, 202808010101, and every 20280829 "
