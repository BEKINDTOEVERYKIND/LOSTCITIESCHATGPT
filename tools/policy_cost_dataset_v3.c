...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202701100101), UINT64_C(202701110101),
      UINT64_C(202701120101), UINT64_C(202701130101),
      UINT64_C(202701160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202701100201), UINT64_C(202701110201),
      UINT64_C(202701120201), UINT64_C(202701130201),
      UINT64_C(202701160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202701100301), UINT64_C(202701110301),
      UINT64_C(202701120301), UINT64_C(202701130301),
      UINT64_C(202701160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v3\","
        ...
        (unsigned long long)root_seed,c->smoke?"20270129-smoke":"locked-discovery",
...
static void expected_allocation_rule(int is_vector,unsigned char out[32])
{
    static const char train[]=
        "lc-policy-cost-train-allocation-v3|canonical-greedy-selection|"
                           ...
                           AllocationManifest *m,unsigned char file_hash[32])
{
    ...
    if(!strcmp(line,"LCPOLICYCOST-TRAIN-ALLOCATION-V3\n"))m->is_vector=0;
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20270129...]\n"
      ...
      "seed must be in the burned 20270129 namespace and is labeled unusable "
      ...
      "202612010101, 202701010101, and every 20270129 feasibility-smoke "
      "seed are "
