...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202702100101), UINT64_C(202702110101),
      UINT64_C(202702120101), UINT64_C(202702130101),
      UINT64_C(202702160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202702100201), UINT64_C(202702110201),
      UINT64_C(202702120201), UINT64_C(202702130201),
      UINT64_C(202702160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202702100301), UINT64_C(202702110301),
      UINT64_C(202702120301), UINT64_C(202702130301),
      UINT64_C(202702160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20270229",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v4\","
        ...
        (unsigned long long)root_seed,c->smoke?"20270229-smoke":"locked-discovery",
    ...
    fprintf(reservoir.file,"%s\nsplit\t%s\npurpose\t%s\nseed\t%llu\n"
        ...
        c->split==SPLIT_TRAIN?"LCPOLICYCOST-TRAIN-RESERVOIR-V4":
...
static void expected_allocation_rule(int is_vector,unsigned char out[32])
{
    static const char train[]=
        "lc-policy-cost-train-allocation-v4|canonical-greedy-selection|"
                           ...
                           AllocationManifest *m,unsigned char file_hash[32])
{
    ...
    if(!strcmp(line,"LCPOLICYCOST-TRAIN-ALLOCATION-V4\n"))m->is_vector=0;
                                ...
                                BoundReservoir *out,unsigned char file_hash[32])
{
    ...
    n=getline(&line,&cap,f);if(n<0)goto bad;
    if(!strcmp(line,"LCPOLICYCOST-TRAIN-RESERVOIR-V4\n"))out->is_vector=0;
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20270229...]\n"
      ...
      "seed must be in the burned 20270229 namespace and is labeled unusable "
      ...
      "202701010101, 202702010101, and every 20270229 "
