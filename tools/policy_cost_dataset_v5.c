...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202703100101), UINT64_C(202703110101),
      UINT64_C(202703120101), UINT64_C(202703130101),
      UINT64_C(202703160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202703100201), UINT64_C(202703110201),
      UINT64_C(202703120201), UINT64_C(202703130201),
      UINT64_C(202703160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202703100301), UINT64_C(202703110301),
      UINT64_C(202703120301), UINT64_C(202703130301),
      UINT64_C(202703160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20270329",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20270329-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202702010101, 202703010101, and every "
        "20270329 feasibility-smoke seed\"}\n");
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20270329...]\n"
      ...
      "seed must be in the burned 20270329 namespace and is labeled unusable "
      ...
      "202702010101, 202703010101, and every 20270329 "
