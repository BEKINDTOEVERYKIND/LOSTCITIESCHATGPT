...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202704100101), UINT64_C(202704110101),
      UINT64_C(202704120101), UINT64_C(202704130101),
      UINT64_C(202704160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202704100201), UINT64_C(202704110201),
      UINT64_C(202704120201), UINT64_C(202704130201),
      UINT64_C(202704160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202704100301), UINT64_C(202704110301),
      UINT64_C(202704120301), UINT64_C(202704130301),
      UINT64_C(202704160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20270429",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20270429-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202703010101, 202704010101, and every "
        "20270429 feasibility-smoke seed\"}\n");
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20270429...]\n"
      ...
      "seed must be in the burned 20270429 namespace and is labeled unusable "
      ...
      "202703010101, 202704010101, and every 20270429 "
