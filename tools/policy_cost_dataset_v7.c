...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202705100101), UINT64_C(202705110101),
      UINT64_C(202705120101), UINT64_C(202705130101),
      UINT64_C(202705160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202705100201), UINT64_C(202705110201),
      UINT64_C(202705120201), UINT64_C(202705130201),
      UINT64_C(202705160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202705100301), UINT64_C(202705110301),
      UINT64_C(202705120301), UINT64_C(202705130301),
      UINT64_C(202705160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20270529",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20270529-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202704010101, 202705010101, and every "
        "20270529 feasibility-smoke seed\"}\n");
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20270529...]\n"
      ...
      "seed must be in the burned 20270529 namespace and is labeled unusable "
      ...
      "202704010101, 202705010101, and every 20270529 "
