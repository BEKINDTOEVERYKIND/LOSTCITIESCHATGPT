...
static const SplitDomain SPLIT_DOMAIN[3] = {
    { "TRAIN",  UINT64_C(202707100101), UINT64_C(202707110101),
      UINT64_C(202707120101), UINT64_C(202707130101),
      UINT64_C(202707160101),
      PC_TRAIN_TRUTH_WORLDS },
    { "SELECT", UINT64_C(202707100201), UINT64_C(202707110201),
      UINT64_C(202707120201), UINT64_C(202707130201),
      UINT64_C(202707160201),
      PC_HOLDOUT_TRUTH_WORLDS },
    { "TEST",   UINT64_C(202707100301), UINT64_C(202707110301),
      UINT64_C(202707120301), UINT64_C(202707130301),
      UINT64_C(202707160301),
      PC_HOLDOUT_TRUTH_WORLDS },
};
...
static int smoke_seed_valid(uint64_t seed)
{
    ...
    return strlen(b)==12&&!strncmp(b,"20270729",8);
}
...
static int run_discover(const DiscoverConfig *c)
{
    ...
    fprintf(evidence.file,"{\"schema\":\"lc-policy-cost-discovery-v5\","
        ...
        (unsigned long long)root_seed,c->smoke?"20270729-smoke":"locked-discovery",
    ...
    fprintf(evidence.file,"],\"pooled_ge64\":\"census_only\","
        ...
        "feasibility-smoke seed, 202705010101, 202707010101, and every "
        "20270729 feasibility-smoke seed\"}\n");
...
static void usage(FILE *f,const char *argv0)
{
    fprintf(f,
      ...
      "[--reservoir-per-cell N] [--smoke-seed 20270729...]\n"
      ...
      "seed must be in the burned 20270729 namespace and is labeled unusable "
      ...
      "202705010101, 202707010101, and every 20270729 "
